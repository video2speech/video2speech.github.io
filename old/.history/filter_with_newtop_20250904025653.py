...
def process_movie_lines(movie_file, vocab_file, output_file, max_lines=None):
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(f"# 电影台词 - 仅包含 newtop.txt 词汇表的句子 (≥4词，不含标点)\n")
    ...
    with open(stats_file, 'w', encoding='utf-8') as f:
        f.write("电影台词词汇过滤统计报告 - newtop.txt\n")
        f.write("=" * 50 + "\n\n")
...
def main():
    ...
    vocab_file = "newtop.txt"
    output_file = "filtered_sentences_newtop.txt"
    max_lines = 30000  # 处理更多行以获得更多有效句子
