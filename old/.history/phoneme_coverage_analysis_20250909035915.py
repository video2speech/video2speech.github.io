...
def main():
    ...
    print("Finding minimal coverage with at least 2 words per phoneme...")
    k, top_k_words, word_to_phonemes = find_minimal_coverage_with_min_words(word_frequencies, min_words_per_phoneme=2)
