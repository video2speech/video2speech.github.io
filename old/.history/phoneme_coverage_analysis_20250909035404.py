...
def analyze_phoneme_word_counts(word_to_phonemes: Dict[str, Set[str]]) -> Tuple[Dict[str, List[str]], Dict[str, List[str]]]:
    """
    Find phonemes with limited word representations.
    Returns (single_word_phonemes, dual_word_phonemes).
    """
    ...
    # Find phonemes with only one or two words
    ...
    return single_phoneme_words, dual_phoneme_words
