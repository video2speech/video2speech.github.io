...
def create_histogram(phoneme_counter):
    ...
    bars = plt.bar(range(len(phonemes)), frequencies, color='skyblue', edgecolor='navy', alpha=0.7)
    
    # Customize the plot
    plt.title('CMU Phoneme Frequency Distribution in Selected Sentences', fontsize=16, fontweight='bold')
